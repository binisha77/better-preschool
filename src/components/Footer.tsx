...
export default function Footer() {
  return (
  <footer className="bg-white rounded-t-[3.5rem] pt-10 pb-4 px-6 md:px-20 relative z-20 -mt-12 ">
      <div className="w-full mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-8 mb-6 items-start">
          ...
          <div className="space-y-2">
             <h2 className="text-[22px] item-center font-bold font-poppins text-[#1C1C1C]">Better<span className="text-brand-blue">Montessori</span>
             </h2>
             <p className="text-[#797979] text-[18px] leading-tight max-w-[292px] h-[87px]">
               Track growth, celebrate milestones, support development.
            </p>
           </div>
          <div className='flex flex-row grid '>
             <h3 className="font-bold text-black mb-3 text-base">Product</h3>
             <ul className="space-y-1 text-black text-[18px]">
          ...
          <div>
            <h3 className="font-bold text-black mb-3 text-base">Company</h3>
             <ul className="space-y-1 text-black text-[18px]">
          ...
          <div className="flex flex-col gap-4">
             <div className="flex flex-col gap-2">
              <h3 className="text-[#28849F] text-[18px] leading-none ">Get the latest information</h3>
               <div className="relative max-w-sm">
                 <input 
                  type="email" 
                  placeholder="E-mail Address" 
                 className="w-full bg-[#949494]/20 border-none rounded-full px-5 py-2.5 text-sm outline-none pr-12 placeholder:text-slate-700 text-slate-900"
                 />
             ...
             <nav className="flex items-center gap-[12px] w-[234px] h-[32px] pt-5">
    ...
    <div className="  border-t border-[#BBBBBB] pt-4 flex flex-col md:flex-row justify-between items-center ">
          ...
          <div className="flex gap-6 text-black text-[18px] font-medium">
